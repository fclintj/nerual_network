...
%  └────────────────────────┘
    ...
    \DeclareDocumentCommand{\program}{} {
        ...
        The Training of the system is done using back propagation with gradient decent and mini-batches. Mini-batches are described in \reff{sec:ten-class}, but I would like to explain the back propagation portion of the code.
        ...
        \lstpy{../python/deepnn.py}{Back propagation}{lst:back-prop}[141][179]
    }
    ...
    \DeclareDocumentCommand{\twoclass}{} {
        ...
        \lstpy{../python/deepnn.py}{Creating 80\% 20\% Data}{lst:creating-data}[338][367]
    ...
    \DeclareDocumentCommand{\tenclass}{} {
        ...
        \lstpy{./media/mnist/ten-class-network_statistics-bat-100-mse-50.txt}{Output Accuracy on MNIST Test Data}{lst:}[0][100]
    }
